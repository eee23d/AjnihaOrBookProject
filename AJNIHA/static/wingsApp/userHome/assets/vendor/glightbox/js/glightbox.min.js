!function (e, t) {
    ...
    function o(e, t) {
        if ((C(e) || e === window || e === document) && (e = [e]), A(e) || L(e) || (e = [e]), 0 != P(e)) if (A(e) && !L(e)) for (var i = e.length, n = 0; n < i && !1 !== t.call(e[n], e[n], n, e); n++) ; else if (L(e)) for (var s in e) if (O(e, s) && !1 === t.call(e[s], e[s], s, e)) break
    }
    ...
    function S(e, t, i) {
        if (I(e)) console.error("Inject assets error"); else if (T(t) && (i = t, t = !1), k(t) && t in window) T(i) && i(); else {
            var n;
            if (-1 !== e.indexOf(".css")) {
    ...
    function W(e) {
        ...
        var t, i, n, s = y(), l = s.width, o = s.height, r = !1, a = null, g = null, f = null, p = !1, m = 1, x = 1,
            b = !1, S = !1, w = null, T = null, k = null, C = null, E = 0, A = 0, L = !1, I = !1, O = {}, P = {}, M = 0,
            X = 0, z = document.getElementById("glightbox-slider"), Y = document.querySelector(".goverlay"),
            q = new _(z, {
    ...
    function F(e, t, i, n) {
        ...
        "file" == u && (u = "http"), r.style.maxWidth = t.width, S(this.settings.plyr.js, "Plyr", (function () {
            ...
            var k = O(s.settings.plyr, "config") ? s.settings.plyr.config : {}, C = new Plyr("#" + o, k);
    ...
    var $ = function () {
        ...
        Q = document.getElementsByTagName("html")[0], ee = {
            ...
            slideHTML: '<div class="gslide">\n    <div class="gslide-inner-content">\n        <div class="ginner-container">\n            <div class="gslide-media">\n            </div>\n            <div class="gslide-description">\n                <div class="gdesc-inner">\n                    <h2 style="text-align: right" class="gslide-title"></h2>\n                    <div class="gslide-desc"></div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>',
            lightboxHTML: '<div  id="glightbox-body" class="glightbox-container" tabindex="-1" role="dialog" aria-hidden="false">\n    <div class="gloader visible"></div>\n    <div class="goverlay"></div>\n    <div class="gcontainer">\n    <div id="glightbox-slider" class="gslider"></div>\n    <button class="gclose gbtn" aria-label="Close" data-taborder="3">{closeSVG}</button>\n    <button disabled class="gprev gbtn" aria-label="Previous" data-taborder="2">{prevSVG}</button>\n    <button disabled class="gnext gbtn" aria-label="Next" data-taborder="1">{nextSVG}</button>\n</div>\n</div>'
        }, te = function () {
            function e() {
                var i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            ...
            return n(e, [{
                ...
                key: "insertSlide", value: function () {
                    ...
                    var i = new U(e, this, t), n = i.getConfig(), s = l({}, n), o = i.create(),
                ...
                key: "resize", value: function () {
                    ...
                    if ((e = e || this.activeSlide) && !c(e, "zoomed")) {
                        ...
                        if (l <= 768 ? h(document.body, "glightbox-mobile") : d(document.body, "glightbox-mobile"), i || n) {
                            var r = !1;
                            if (s && (c(s, "description-bottom") || c(s, "description-top")) && !c(s, "gabsolute") && (r = !0), n) if (l <= 768) {
                                var a = n.querySelector("img");
                                a.setAttribute("style", "")
                            } else if (r) {
                                var u = s.offsetHeight, g = n.querySelector("img");
                            ...
                            if (i) {
                                ...
                                if (!v) {
                                    var f = i.clientWidth, p = i.clientHeight, m = f / p;
                                    v = "".concat(f / m, ":").concat(p / m)
                                }
                                var x = v.split(":"), b = this.settings.videosWidth, S = this.settings.videosWidth,
                                ...
                                if (w = Math.floor(w), r && (o -= s.offsetHeight), S > l || w > o || o < w && l > S) {
                                    var T = i.offsetWidth, k = i.offsetHeight, C = o / k, E = {width: T * C, height: k * C};
